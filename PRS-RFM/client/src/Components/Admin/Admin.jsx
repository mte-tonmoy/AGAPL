...
const Admin = () => {
  ...
  useEffect(() => {
    fetch("https://prs-server-7b9t.onrender.com/allUser")
      .then((res) => res.json())
      .then((data) => setUsers(data));
  }, [users]);

  const handleMakeManager = (user) => {
    fetch(`https://prs-server-7b9t.onrender.com/makeManager/${user._id}`, {
      method: "PATCH",
    })
      .then((res) => res.json())
      .then((data) => {
  ...
  const handleMakeStoreMan = (user) => {
    fetch(`https://prs-server-7b9t.onrender.com/makeStoreMan/${user._id}`, {
      method: "PATCH",
    })
      .then((res) => res.json())
      .then((data) => {
  ...
  const handleMakeUser = (user) => {
    fetch(`https://prs-server-7b9t.onrender.com/makeUser/${user._id}`, {
      method: "PATCH",
    })
      .then((res) => res.json())
      .then((data) => {
